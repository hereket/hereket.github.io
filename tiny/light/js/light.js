...
console.log(color_polygon, color_light, color_background);
...
function init_light() {
    ...
    setTimeout(function(){ 
        // console.log(wrapper_body.offsetWidth, wrapper_body.offsetHeight);
        // console.log(wrapper_body.offsetWidth, wrapper_body.offsetHeight);
        ...
        var padding = {x: canvas.width * 0.1, y: canvas.height * 0.05};
        var dimension = [-1.9022006,-88.579883]
        polygons = normalize_to_scale(polygons, dimension, padding, canvas.width, canvas.height);
        ...
        wrapper_body.addEventListener('mousemove', function(e) {
            ...
            // console.log('mouse drawing:', context);
            draw_polygons(context, polygons);;
            drawRay(context, segments, Center, Mouse);
        });
...
// center - for padding
function normalize_to_scale(polygons, dim, padding, width, height) {
    var x_max = 0;
    var y_max = 0;
    ...
    var scale_x = new_width / x_max;
    var scale_y = new_height / y_max;
